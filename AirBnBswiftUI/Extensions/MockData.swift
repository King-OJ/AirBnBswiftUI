...
class MockData {
    ...
    [
        ...
        .init(
            ...
            title: "Royal Flat",
            rating: 2.5,
            features: [.tv, .laundry, .pool, .alarmSystem],
            categories: [.superHost, .selfCheckIn],
            type: .villa
        ),
        .init(
